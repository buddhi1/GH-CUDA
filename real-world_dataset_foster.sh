...
# instructions
echo "Usage: /bin/bash real-world_dataset_foster.sh [option] [save]"
...
if ! [[ $1 =~ $re ]] ; then
    ...
    ./polyclip data/realworld/${base[$(($1-1))]}.txt  data/realworld/${overlay[$(($1-1))]}.txt optimizedFostersAlgorithm/results/results_${base[$(($1-1))]}_${overlay[$(($1-1))]}.poly save debug
fi
