# script run test cases in synthetic dataset
...
# instructions
echo "Usage: /bin/bash synthetic_dataset_foster.sh [option] [save]"
echo -e "Run all: option=<>\nDebug mode: option= [1-8]\n"
...
if ! [[ $1 =~ $re ]] ; then
    ...
    ./polyclip data/synthetic/${base[$(($1-1))]}.txt  data/synthetic/${overlay[$(($1-1))]}.txt optimizedFostersAlgorithm/results/results_${base[$(($1-1))]}_${overlay[$(($1-1))]}.poly save debug
fi
